...
/// exactamente la misma secuencia siempre; es la ÚNICA fuente de
/// aleatoriedad usada dentro de `generate`, consumida en un orden
/// estrictamente secuencial y fijo.
struct Rng(u64);
